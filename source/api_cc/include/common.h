...
/**
 * @brief Read model file to a torch module.
 * @param[in] model Path to the model.
 * @param[out] pt_module Pytorch module.
 **/
void read_file_to_module(std::string model, torch::jit::script::Module& pt_module);
