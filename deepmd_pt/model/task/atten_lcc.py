...
from deepmd_pt.model.network import EnergyHead, NodeTaskHead
from deepmd_pt.model.task import TaskBaseMethod


class FittingNetAttenLcc(TaskBaseMethod):

    def __init__(self, embedding_width, bias_atom_e, pair_embed_dim, attention_heads, **kwargs):
        """
        ...
        Args:
            ...
            **kwargs:
        """
        super(FittingNetAttenLcc, self).__init__()
        ...
        self.node_proc = NodeTaskHead(self.embedding_width, self.pair_embed_dim, self.attention_heads)
