# modified from ocp/ocpmodels/models/base.py
    ...
    def generate_graph(
        ...
        if use_pbc:
            ...
            out = get_pbc_distances(
                ...
                remove_zero_dist_edges=otf_graph,  # TODO: it is always True in original ocpmodels
            )
