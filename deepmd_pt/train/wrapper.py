...
class ModelWrapper(torch.nn.Module):
    ...
    def forward(self, coord, atype, natoms, mapping, shift, selected, box=None, cur_lr=None, label=None, task_key=None):
        ...
        model_pred = self.model[task_key](coord, atype, natoms, mapping, shift, selected, box=box)
